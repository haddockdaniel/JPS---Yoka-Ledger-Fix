namespace JurisUtilityBase
{
    partial class UtilityBaseMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelDescription.Text = "Fixes the cash receipt post that makes bill 43422 have 9 cents too many in its al" +
    "location. This will also fix the AR balance issue.";
